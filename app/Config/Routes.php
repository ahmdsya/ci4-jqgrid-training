...
$routes->get('/get', 'Pelanggan::get');
$routes->get('/pesanan/(:num)', 'Pesanan::index/$1');
$routes->get('/edit/(:num)', 'Pelanggan::edit/$1');
$routes->get('/add', 'Pelanggan::add');
$routes->get('/delete/(:num)', 'Pelanggan::delete/$1');
$routes->get('/truncate', 'Pelanggan::truncate');
// $routes->get('/report', 'Pelanggan::report');
$routes->post('/store', 'Pelanggan::store');
$routes->post('/update/(:num)', 'Pelanggan::update/$1');
$routes->post('/destroy/(:num)', 'Pelanggan::destroy/$1');
